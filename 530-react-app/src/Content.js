...
<br/><br/><br/>
          ...
          <div className="text-center" style={styles.textPadding}>
      <br/>
...
<p>Pick a framework or CMS of your choice (list below - one framework/CMS per team - will be on a first claimed basis). You create a website that presents the framework/CMS in a concise fashion as a tutorial.</p>
    <br/>  <br/>

<p>Your website shall have 6 pages, all done using the framework/CMS of your choice. Following are the requirements for each of the six pages.</p>
    <br/>  <br/>
