      ...
      <nav className="navbar navbar-inverse bg-inverse navbar-fixed-top">
        <div className="container">
          <div className="navbar-header">
            ...
            <Link to="/" className="navbar-brand"><strong><img style={{width:'20px', height:'20px'}} align="left" src="https://cdn.worldvectorlogo.com/logos/react-1.svg"/><a style={{color:'#60D7F7'}}>React-Project</a></strong></Link>
          </div>
