      ...
      <div className="content">
        <div className="panel panel-info">
          ...
          <div className="panel-body">
            <div>
              <h2 className="text-center">What is React.js?</h2>
            ...
            <div>
              <h2 className="text-center">How popular is React.js?</h2>
              <p style={styles.textStyle}>
            ...
            <div>
              <h2 className="text-center">What kind of websites use it?</h2>
              <p style={styles.textStyle}>
            ...
            <div>
              <h2 className="text-center">What are React's strengths?</h2>
              <p style={styles.textStyle}>
            ...
            <div>
              <h2 className="text-center">What are React's weaknesses?</h2>
              <p style={styles.textStyle}>
